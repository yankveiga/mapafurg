...
// Restaurante Universitário - Lago - Requer atualização presencial semanal
  ...
  // C3 - Centro de Ciências Computacionais
    ...
    projetos: [
      { sigla: "PET C3", nome: "PET Ciências Computacionais", sala: "Sala 114", link: "https://instagram.com/petc3furg" },
      { sigla: "LAMSA", nome: "Laboratório de Modelagem e Simulação Social e Ambiental", sala: "Sala 108", link: "" }, // Sem link
      { sigla: "E-colab", nome: "E-colab", sala: "Sala 117", link: "https://www.instagram.com/ecolab.furg/" },// quando tiver sigla
      { sigla: "FBOT", nome: "FBOT", sala: "Sala 225", link: "https://instagram.com/furgbot" },
      { sigla: "NAUTEC", nome: "Grupo de Automação e Robótica Inteligente", sala: "Sala 226", link: "https://www.instagram.com/nautec.furg/" },
      { sigla: "REHABOT", nome: "Robótica Gamificada na Reabilitação Fisioterapêutica", sala: "Sala 116", link: "" },
      { sigla: "Safe Eye", nome: "Safe Eye", sala: "Sala 116", link: "" },
      { sigla: "DTWIN", nome: "Digital Twin", sala: "Sala 116", link: "" },
      { sigla: "WEARABLE", nome: "WEARABLE", sala: "Sala 116", link: "" },
      { sigla: "GSDE", nome: "GSDE", sala: "Sala 219", link: "" },
      { sigla: "BEVLOG", nome: "Bird's Eye View Robóticos Para Ambientes", sala: "Sala 212", link: "" },
      { sigla: "NAVMS", nome: "Navegação Multissensorial no Contexto de Degradação de GNSS", sala: "Sala 212", link: "" },
      { sigla: "Mão Extra", nome: "Mão Extra", sala: "Sala 213", link: "" },
      { sigla: "Igapó", nome: "Igapó", sala: "Sala 213", link: "" },
      { sigla: "Saca Agulhas", nome: "Saca Agulhas", sala: "Sala 213", link: "" },
      { sigla: "GINFO", nome: "Grupo de Gerenciamento de Informações", sala: "Sala 220", link: "" },
      { sigla: "GFLEX", nome: "Grupo de Gerenciamento de Informações e Computação Flexível", sala: "Sala 220", link: "" },
